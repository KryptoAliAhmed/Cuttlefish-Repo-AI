  ...
  return (
    <div style={formStyle}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label style={labelStyle}>Proj. Financial: </label>
          <input
            type="number"
            value={financial}
        ...
        <div>
          <label style={labelStyle}>Proj. Ecological: </label>
          <input
            type="number"
            value={ecological}
            onChange={(e) => setEcological(Number(e.target.value))}
            required
            style={inputStyle}
          />
        </div>
        <div>
          <label style={labelStyle}>Proj. Social: </label>
          <input
            type="number"
            value={social}
